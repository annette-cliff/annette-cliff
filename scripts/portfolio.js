...
var portfolioContent = [
    { 
      ...
      desktop_ratio_width: '2868',
      desktop_ratio_height: '1346',
      mobile_image: '../assets/our-lady-of-rocco/mobile.webp',
      mobile_ratio_width: '1110',
      mobile_ratio_height: '1365',
      ...
      image_2_ratio_width: '1744',
      image_2_ratio_height: '1048',
      ...
      image_3_ratio_width: '1738',
      image_3_ratio_height: '1026',
      ...
      image_4_ratio_width: '1746',
      image_4_ratio_height: '1020',
    ...
    { 
      ...
      desktop_ratio_width: '2872',
      desktop_ratio_height: '1354',
      mobile_image: '../assets/puppets-and-puppets/mobile.webp',
      mobile_ratio_width: '1114',
      mobile_ratio_height: '1356',
      title_first: 'Puppets &',
    ...
    { 
      ...
      desktop_ratio_width: '2866',
      desktop_ratio_height: '1350',
      mobile_image: '../assets/bethel-china/mobile.webp',
      mobile_ratio_width: '1082',
      mobile_ratio_height: '1364',
      title_first: 'Bethel',
      title_second: 'China',
      ...
      image_2_ratio_width: '2862',
      image_2_ratio_height: '1162',
      ...
      image_3_ratio_width: '2876',
      image_3_ratio_height: '1342',
      ...
      image_4_ratio_width: '1690',
      image_4_ratio_height: '992',
    ...
    { 
      ...
      desktop_ratio_width: '1396',
      desktop_ratio_height: '886',
      mobile_image: '../assets/blackcraft-cult/mobile.webp',
      mobile_ratio_width: '386',
      mobile_ratio_height: '842',
      ...
      image_2_ratio_width: '2870',
      image_2_ratio_height: '1320',
      ...
      image_3_ratio_width: '1678',
      image_3_ratio_height: '1164',
      ...
      image_4_ratio_width: '1680',
      image_4_ratio_height: '1040',
...
const portfolioGridHTML = portfolioContent
  .map(item => `<div class="grid-item" tabindex="0" data-trigger-modal="${item.title.toLowerCase().replace(/ +/g, '-').replace('&', 'and')}">
                    ...
                    <picture>
                      ...
                      <img src="${item.desktop_image}" alt="${item.title}'s homepage image on desktop" width="${item.desktop_ratio_width ? `${item.desktop_ratio_width}` : '2880'}" height="${item.desktop_ratio_height ? `${item.desktop_ratio_height}` : '1360'}" class="desktop-only">
                    </picture>
                    <picture>
                      <source type="image/webp" srcset="${item.mobile_image}" media="(max-width: 600px)" />
                      <img src="${item.mobile_image}" alt="${item.title}'s homepage image on mobile" width="${item.mobile_ratio_width ? `${item.mobile_ratio_width}` : '1115'}" height="${item.mobile_ratio_height ? `${item.mobile_ratio_height}` : '1356'}" class="mobile-only">
                    </picture>
                </div>`)
  .join('');
  ...
  const imagesOneHTML = `
    <div class="image__featured-left">
      <picture>
        ...
        <img src="${modal.image_1}" alt="${modal.image_1_alt}" width="${modal.image_1_ratio_width ? `${modal.image_1_ratio_width}` : '730'}" height="${modal.image_1_ratio_height ? `${modal.image_1_ratio_height}` : '345'}" loading="lazy">
      </picture>
    </div>
    <div class="image__featured-right">
      <picture>
        <source type="image/webp" srcset="${modal.image_2}" media="(min-width: 600px)" />
        <img src="${modal.image_2}" alt="${modal.image_2_alt}" width="${modal.image_2_ratio_width ? `${modal.image_2_ratio_width}` : '730'}" height="${modal.image_2_ratio_height ? `${modal.image_2_ratio_height}` : '345'}" loading="lazy">
      </picture>
    </div>
  `;
  ...
  const imagesTwoHTML = `
    <div class="image__featured-left">
      <picture>
        ...
        <img src="${modal.image_3}" alt="${modal.image_3_alt}" width="${modal.image_3_ratio_width ? `${modal.image_3_ratio_width}` : '730'}" height="${modal.image_3_ratio_height ? `${modal.image_3_ratio_height}` : '345'}" loading="lazy">
      </picture>
    </div>
    <div class="image__featured-right">
    ...
    : `<picture>
        ...
        <img src="${modal.image_4}" alt="${modal.image_4_alt}" width="${modal.image_4_ratio_width ? `${modal.image_4_ratio_width}` : '730'}" height="${modal.image_4_ratio_height ? `${modal.image_4_ratio_height}` : '345'}" loading="lazy">
      </picture>`
    }
    </div>
  `;
  ...
  .map(tech =>
    `<li>
      <picture> 
        ...
        <img src="${tech.tech_image}" alt="Logo for ${tech.tech_name}"  width="${tech.aspect_ratio ? `${tech.aspect_ratio}` : '920'}" height="${tech.aspect_ratio ? `${tech.aspect_ratio}` : '840'}" loading="lazy">
      </picture>
    </li>`)
  .join('');
